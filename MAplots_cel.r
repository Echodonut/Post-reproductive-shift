...
#When running the script for multiple datasets, don't forget to change nums in l16-20 and l40, and fiddle around title position on l79
...
sample_info <- data.frame(
  condition = factor(rep(c("Day 5", "Day 10"), each = 3)),
...
png(png_tit, width = 7, height = 7, units = "in", res = 300)
  ...
  usr <- par("usr")
  text(x = 0.044, y = (usr[4]*0.95), labels = fig_tit, pos = 4, cex = 2, font = 2)
